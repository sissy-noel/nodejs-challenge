...
export const decrypt = function(encdata, masterkey){
    // base64 decoding
...
export const decrypt4 = function (dataBuffer, keyBuffer){
...
export const decrypt3 = function(encdata, masterkey){
...
export const decrypt2 = function(encdata, masterkey){
    let textParts = encdata.split(':');
